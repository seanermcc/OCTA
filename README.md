...
**Status: the segmentation core works and is validated on one wild-type and one
CNV scan, now against published tree shrew layer thicknesses. The batch run over
all 314 scans has not happened yet.**
