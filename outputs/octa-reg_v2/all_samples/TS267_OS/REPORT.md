# TS267_OS: pooled retinal montage

27 source scans: 5 overlap-supported, 22 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **5.23 mm²**, or **2.55 single-field areas**. Including tentative placements gives 11.00 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.10 µm and excludes five border pixels and nonfinite observations.
