# TS247_OD: pooled retinal montage

34 source scans: 27 overlap-supported, 6 uncertain proposals, 0 unlocalized, 1 explicitly excluded.
...
Supported union coverage: approximately **6.26 mm²**, or **3.06 single-field areas**. Including tentative placements gives 9.57 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.18 µm and excludes five border pixels and nonfinite observations.
