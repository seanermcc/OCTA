# TS325_OD: pooled retinal montage

34 source scans: 11 overlap-supported, 23 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **7.98 mm²**, or **3.89 single-field areas**. Including tentative placements gives 11.39 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.69 µm and excludes five border pixels and nonfinite observations.
