# TS336_OD: pooled retinal montage

30 source scans: 19 overlap-supported, 11 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **7.18 mm²**, or **3.50 single-field areas**. Including tentative placements gives 11.55 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.29 µm and excludes five border pixels and nonfinite observations.
