# TS165_OS: pooled retinal montage

10 source scans: 6 overlap-supported, 4 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **5.44 mm²**, or **2.66 single-field areas**. Including tentative placements gives 7.25 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 2.85 µm and excludes five border pixels and nonfinite observations.
