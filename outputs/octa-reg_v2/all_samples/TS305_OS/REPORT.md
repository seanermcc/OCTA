# TS305_OS: pooled retinal montage

2 source scans: 1 overlap-supported, 1 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **2.05 mm²**, or **1.00 single-field areas**. Including tentative placements gives 3.55 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 2.85 µm and excludes five border pixels and nonfinite observations.
