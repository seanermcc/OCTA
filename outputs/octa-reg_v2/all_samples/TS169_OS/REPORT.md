# TS169_OS: pooled retinal montage

4 source scans: 4 overlap-supported, 0 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **2.89 mm²**, or **1.41 single-field areas**. Including tentative placements gives 2.89 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 2.85 µm and excludes five border pixels and nonfinite observations.
