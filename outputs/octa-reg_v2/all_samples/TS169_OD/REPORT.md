# TS169_OD: pooled retinal montage

9 source scans: 2 overlap-supported, 7 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **2.29 mm²**, or **1.12 single-field areas**. Including tentative placements gives 5.99 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 2.91 µm and excludes five border pixels and nonfinite observations.
