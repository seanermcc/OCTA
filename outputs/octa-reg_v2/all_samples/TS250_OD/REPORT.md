...
Supported union coverage: approximately **4.57 mm²**, or **2.23 single-field areas**. Including tentative placements gives 7.36 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.06 µm and excludes five border pixels and nonfinite observations.
