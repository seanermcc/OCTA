# TS250_OS: pooled retinal montage

9 source scans: 7 overlap-supported, 2 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **6.42 mm²**, or **3.13 single-field areas**. Including tentative placements gives 8.39 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 2.97 µm and excludes five border pixels and nonfinite observations.
