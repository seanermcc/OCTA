# TS241_OD: pooled retinal montage

26 source scans: 14 overlap-supported, 12 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **6.97 mm²**, or **3.40 single-field areas**. Including tentative placements gives 10.77 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.47 µm and excludes five border pixels and nonfinite observations.
