...
if __name__=='__main__':
    parser=argparse.ArgumentParser();parser.add_argument('--model',type=int,choices=[1,2],required=True);args=parser.parse_args()
    try:run(args.model)
