...
26 source scans: 0 overlap-supported, 26 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **0.00 mm²**, or **0.00 single-field areas**. Including tentative placements gives 8.87 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.10 µm and excludes five border pixels and nonfinite observations.
