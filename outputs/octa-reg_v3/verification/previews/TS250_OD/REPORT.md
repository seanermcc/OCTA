# TS250_OD: pooled retinal montage

10 source scans: 3 overlap-supported, 7 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **3.64 mm²**, or **1.78 single-field areas**. Including tentative placements gives 7.38 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 3.05 µm and excludes five border pixels and nonfinite observations.
