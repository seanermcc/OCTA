# TS247_OS: pooled retinal montage

12 source scans: 10 overlap-supported, 2 uncertain proposals, 0 unlocalized, 0 explicitly excluded.
...
Supported union coverage: approximately **5.49 mm²**, or **2.68 single-field areas**. Including tentative placements gives 6.20 mm²; that separate number is not established retinal coverage. Scale is approximate, 1460/512 µm per native pixel. Coverage is rasterized at 2.85 µm and excludes five border pixels and nonfinite observations.
