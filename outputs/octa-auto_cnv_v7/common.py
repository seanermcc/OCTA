"""V7-only destinations. Older releases are immutable inputs, never imports."""
...
def destination(path):
    ...
    if not p.is_relative_to(HERE):
        raise ValueError('All v7 writes must stay inside ' + str(HERE))
