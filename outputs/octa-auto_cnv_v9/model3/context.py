...
def load_context(a):
 ...
 if r['excluded_from_analysis']:
  channels,prov=build_context(None,None)
  prov.update(notes='Historical vessel-context exclusion: '+r['notes'],excluded_context=True,
              policy='User explicitly requested all 101 inventory confirmations and full-cohort inference; excluded vessel annotations are withheld as missing context.')
