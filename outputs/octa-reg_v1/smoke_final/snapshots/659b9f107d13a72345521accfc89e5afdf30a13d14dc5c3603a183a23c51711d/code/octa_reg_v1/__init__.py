...
CONFIG.update(seed=1701, bootstrap_samples=100, cnv_mode='off', cnv_snapshot=None,
              ...
              orb_downscale=1.2, orb_n_scales=8, orb_fast_n=9, orb_harris_k=.04,
              ...
              descriptor_metric='hamming (Boolean descriptors)', descriptor_cross_check=True,
              descriptor_max_distance='infinity', ransac_stop_probability=1.,
              ransac_stop_sample_num='infinity', ransac_stop_residuals_sum=0.,
