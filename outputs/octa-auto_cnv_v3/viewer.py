...
class Window(gui.MainWindow):
    def __init__(self, config, **kw):
        ...
        self.setWindowTitle('octa-auto_cnv_v3 · Lesion assessment and manual review · Experimental')
        ...
        self.top.insertWidget(1,self.panel('Structural evidence · not a CNV map',self.evidence))
    ...
    def render_maps(self,*args):
        ...
        if self.screen_check.isChecked():self.overlay(self.evidence,a['geometry_any'],'#b68c83')
