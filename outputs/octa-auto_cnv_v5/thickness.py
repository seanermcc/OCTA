...
def review_config():
    ...
    config['manual_sources'] = [str(ROOT/'outputs/octa-auto_cnv_v4/review/surface_labels'),str(PREVIOUS/'review/surface_labels'),
...
def load_thickness(sid):
    ...
    return volume.maps[0][0].copy(), volume.endpoints[0].copy(), volume.metadata()
